module ApplicationHelper
  ...
  def page_title(bot = nil)
    ...
    is_little_cloud = current_user&.email == "milai-work@little-cloud.jp" || bot&.token == "cbdf74a20f064e84ec1c539ccddc60808b2eba13b5dd5595527b6e017e9b4be4"

    is_little_cloud ? "市民のミカタ - 問い合わせ専用AIチャットボット" : default_title
  end
end
