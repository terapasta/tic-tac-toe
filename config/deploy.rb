...
set :linked_dirs, %w{bin log tmp/backup tmp/pids tmp/cache tmp/sockets vendor/bundle public/uploads, learning/learning/models /learning/learning/vocabulary}
