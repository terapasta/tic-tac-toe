...
ActiveRecord::Schema.define(version: 2019_06_11_072815) do

  create_table "allowed_hosts", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "allowed_ip_addresses", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "answer_files", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "answer_inline_images", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "file", null: false
    t.integer "bot_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "answer_links", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "bad_reasons", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "bot_chatwork_credentials", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "bot_line_credentials", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "bot_microsoft_credentials", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "bots", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "user_id"
    t.string "name"
    ...
    t.float "candidate_answers_threshold", default: 0.1, null: false
    t.boolean "is_guest_user_form_skippable", default: true, null: false
    t.string "password"
    t.integer "suggest_limit", default: 10, null: false
    t.float "top_candidate_answers_threshold", default: 0.0, null: false
    t.index ["user_id"], name: "index_bots_on_user_id"
  end

  create_table "chat_service_users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "bot_id", null: false
  ...
  create_table "chatwork_decision_branches", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "chatwork_similar_question_answers", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "chat_id", null: false
    t.string "access_token", null: false
    ...
    t.datetime "updated_at", null: false
    t.text "question"
    t.index ["access_token"], name: "index_chatwork_similar_question_answers_on_access_token", unique: true
  end

  create_table "data_summaries", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "bot_id", null: false
    t.json "data"
  ...
  create_table "decision_branches", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "dumps", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "bot_id", null: false
  ...
  create_table "guest_users", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name", null: false
    t.string "email"
    t.string "guest_key", null: false
    t.datetime "created_at", null: false
  ...
  create_table "initial_selections", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "bot_id", null: false
    t.integer "question_answer_id", null: false
    t.integer "position", default: 0, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["bot_id", "question_answer_id"], name: "index_initial_selections_on_bot_id_and_question_answer_id", unique: true
  end

  create_table "learning_parameters", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "bot_id"
    t.integer "algorithm", default: 8, null: false
    t.json "parameters"
    t.integer "feedback_algorithm", default: 1, null: false
    t.json "parameters_for_feedback"
    t.float "classify_threshold", default: 0.6, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.float "similar_question_answers_threshold"
    t.index ["bot_id"], name: "index_learning_parameters_on_bot_id"
  end

  create_table "learning_training_messages", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "bot_id"
    t.text "question"
    t.text "answer_body"
    t.datetime "created_at", null: false
  ...
  create_table "organization_bot_ownerships", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "organization_user_memberships", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "question_answers", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "bot_id"
    t.text "question"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "sentence_synonyms", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "sub_questions", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "question_answer_id", null: false
    t.text "question"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "topic_taggings", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "question_answer_id", null: false
  ...
  create_table "topic_tags", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name", null: false
    t.integer "bot_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "word_mapping_synonyms", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "value", null: false
  ...
  create_table "zendesk_credentials", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "bot_id", null: false
