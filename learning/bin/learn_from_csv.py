...
parser.add_argument('--bot_id', default=13, type=int, help='Rails側と重複しないIDを指定')  # bot_id = 13は豊通
...
_evaluator = Bot(args.bot_id, learning_parameter).learn(csv_file_path='bin/files/toyotsu_human.csv', datasource_type='csv')
