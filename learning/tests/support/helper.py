...
class Helper:
    ...
    @classmethod
    def test_context(cls, bot_id, algorithm=Constants.ALGORITHM_FUZZY_COSINE_SIMILARITY_CLASSIFICATION, feedback_algorithm=Constants.FEEDBACK_ALGORITHM_ROCCHIO, datasource=None):
